...
public class GuiObjectBackGround extends GuiObject {
    ...
    public void draw (int left, int top, int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.visible) {
            ...
            RenderUtils.drawTexturedModalRect(this.getX(), this.getY(), this.offsetAltX * 2, this.offsetAltY * 2, this.getWidth(), this.getHeight());
    ...
    public void mouseClickMove (int mouseX, int mouseY, int clickedMouseButton, long timeSinceLastClick) {
        ...
        this.offsetAltX += (this.getParent().getPrevMX() - mouseX) / 2.5f;
        this.offsetAltY += (this.getParent().getPrevMY() - mouseY) / 2.5f;
